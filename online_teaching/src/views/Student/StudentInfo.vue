<template>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm register-page"
        status-icon>
        <el-form-item label="用户名：" prop="sUsername">
            <el-input v-model="ruleForm.sUsername" style="width:250px" disabled></el-input>
        </el-form-item>
        <el-form-item label="姓名：" prop="sName">
            <el-input v-model="ruleForm.sName" style="width:250px"></el-input>
        </el-form-item>
        <el-form-item label="年龄：" prop="sAge">
            <el-input v-model.number="ruleForm.sAge" style="width:100px"></el-input>
        </el-form-item>
    ...
    export default {
        ...
        methods: {
            selectStudentBySid() {
                ...
                this.$axios.post("/api/selectStudentBySid", this.$qs.stringify(params))
                    .then(res => {
            ...
            submitForm() {
                this.$refs.ruleForm.validate(valid => {
                    if (valid) {
                        let params = {
                            sId: sessionStorage.getItem('sId'),
                            age: this.ruleForm.sAge,
                            sex: this.ruleForm.sSex,
                            name: this.ruleForm.sName
                        }
                        let that=this
                        this.$axios.post("/api/updateStudentBySid", this.$qs.stringify(params))
                            .then(res => {
                                console.log(res);
                                that.reload()
                                    this.$message({
